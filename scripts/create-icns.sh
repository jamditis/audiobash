#!/bin/bash
# Creates macOS .icns icon from PNG
# Run this on macOS: ./scripts/create-icns.sh

set -e

SOURCE="audiobash-logo.png"
ICONSET="audiobash-logo.iconset"
OUTPUT="audiobash-logo.icns"
